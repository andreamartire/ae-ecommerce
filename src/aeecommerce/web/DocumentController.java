...
public class DocumentController{
	...
	public String getFaqPost(@ModelAttribute("document") DocumentForm d, ModelMap model){
	...
	public String getCondPost(@ModelAttribute("document") DocumentForm d, ModelMap model){
